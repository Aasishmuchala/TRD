...
class MockResponseGenerator:
    ...
    AGENT_TEMPLATES = {
        ...
        "STOCK_OPTIONS": {
            "RBI_DOVISH": {"direction": "BUY", "conviction": 70, "reasoning": "Rate cut makes banking stock options cheap. IV rank low on ICICIBANK, SBIN. Weekly CE on ICICIBANK looks attractive.", "triggers": ["Banking IV low", "Rate cut catalyst", "ICICIBANK CE setup"]},
            "FII_OUTFLOW": {"direction": "SELL", "conviction": 72, "reasoning": "FII selling hitting large-caps hard. PE on RELIANCE and INFY look good as IV spikes on selling pressure.", "triggers": ["Large-cap weakness", "IV spike on sell-off", "RELIANCE PE setup"]},
            "BUDGET_POSITIVE": {"direction": "BUY", "conviction": 75, "reasoning": "Budget beneficiary stocks showing breakout setups. Infra stock options are cheap. LTIM weekly CE fits budget.", "triggers": ["Infra capex boost", "Cheap IV on budget stocks", "LTIM CE setup"]},
            "BUDGET_NEGATIVE": {"direction": "SELL", "conviction": 68, "reasoning": "Tax hike fears crushing consumption names. PE on HINDUNILVR and TITAN with tight risk/reward.", "triggers": ["Consumption sector hit", "Tax uncertainty", "HINDUNILVR PE setup"]},
            "EXPIRY_WEEK": {"direction": "HOLD", "conviction": 42, "reasoning": "Expiry-week theta decay makes stock options risky. No clean setup — sitting out this week.", "triggers": ["High theta risk", "No edge in stock options", "Capital preservation"]},
            "GLOBAL_CRISIS": {"direction": "SELL", "conviction": 80, "reasoning": "IT stocks crashing on global risk-off. PE on TCS and INFY with high conviction — IV still catching up.", "triggers": ["IT sector collapse", "Global contagion", "TCS PE setup"]},
            "CORPORATE_SHOCK": {"direction": "SELL", "conviction": 74, "reasoning": "Governance scare hitting conglomerate stocks. PE on affected group company with tight stop.", "triggers": ["Governance risk", "Sector sell-off", "Stock-specific PE"]},
            "ELECTION_UNCERTAINTY": {"direction": "HOLD", "conviction": 40, "reasoning": "Binary event makes all stock options expensive. Waiting for post-election clarity before deploying capital.", "triggers": ["Binary event premium", "No edge pre-election", "Capital preservation"]},
            "normal": {"direction": "HOLD", "conviction": 45, "reasoning": "No standout stock options setup today. IV rank neutral across NIFTY50 universe. Waiting for catalyst.", "triggers": ["No catalyst", "IV neutral", "Awaiting setup"]},
            "rally": {"direction": "BUY", "conviction": 68, "reasoning": "Momentum stocks showing breakout setups. Weekly CE on sector leaders with cheap IV.", "triggers": ["Breakout momentum", "Cheap IV on leaders", "Weekly CE setup"]},
            "strength": {"direction": "BUY", "conviction": 60, "reasoning": "Modest trend supports stock CE positions. Looking at banking and auto sector options.", "triggers": ["Trend support", "Sector rotation", "Banking CE"]},
            "weakness": {"direction": "SELL", "conviction": 62, "reasoning": "Weakness creating PE setups in overvalued names. IV starting to expand on dips.", "triggers": ["IV expansion", "PE on weakness", "Overvalued targets"]},
            "correction": {"direction": "SELL", "conviction": 78, "reasoning": "Deep correction = high IV but strong directional setup. PE on large-caps breaking support.", "triggers": ["Support break", "High conviction PE", "Large-cap weakness"]},
        },
        "NEWS_EVENT": {
            "RBI_DOVISH": {"direction": "BUY", "conviction": 55, "reasoning": "RBI rate cut is a known catalyst, not a binary surprise. Low event risk. Supporting directional trade.", "triggers": ["Known event resolved", "Low event risk", "Policy clarity"]},
            "FII_OUTFLOW": {"direction": "HOLD", "conviction": 60, "reasoning": "FII outflow magnitude is uncertain — could accelerate. Moderate event risk. Cautious.", "triggers": ["Flow uncertainty", "Contagion risk", "Moderate caution"]},
            "BUDGET_POSITIVE": {"direction": "BUY", "conviction": 58, "reasoning": "Budget outcome positive and known. No residual binary risk. Supporting trade.", "triggers": ["Event resolved", "Positive outcome", "Low residual risk"]},
            "BUDGET_NEGATIVE": {"direction": "SELL", "conviction": 60, "reasoning": "Budget outcome negative but known. Directional clarity despite the bad news.", "triggers": ["Bad news is priced", "Directional clarity", "No binary risk"]},
            "EXPIRY_WEEK": {"direction": "HOLD", "conviction": 48, "reasoning": "Expiry week is not a binary event. No macro risk detected. Not blocking trade.", "triggers": ["No macro event", "Normal conditions", "Expiry is routine"]},
            "GLOBAL_CRISIS": {"direction": "HOLD", "conviction": 82, "reasoning": "VETO: Global crisis is an evolving binary event. Unknown escalation risk. Blocking all directional trades.", "triggers": ["Binary event active", "Unknown escalation", "TRADE BLOCKED"]},
            "CORPORATE_SHOCK": {"direction": "HOLD", "conviction": 70, "reasoning": "Corporate governance shock has uncertain legal/regulatory outcomes. Moderate event risk.", "triggers": ["Legal uncertainty", "Regulatory risk", "Moderate veto"]},
            "ELECTION_UNCERTAINTY": {"direction": "HOLD", "conviction": 88, "reasoning": "VETO: Election is a pure binary event. Outcome unknown. All directional positions are gambles, not trades.", "triggers": ["Pure binary event", "Outcome unknown", "TRADE BLOCKED"]},
            "normal": {"direction": "BUY", "conviction": 40, "reasoning": "No event risk detected. Normal conditions. Not blocking any trade. Low-conviction directional lean.", "triggers": ["No event risk", "Normal market", "Pass-through"]},
            "rally": {"direction": "BUY", "conviction": 45, "reasoning": "Rally with no macro headwinds. No event risk. Supporting directional trade.", "triggers": ["No event risk", "Momentum intact", "Clear skies"]},
            "strength": {"direction": "BUY", "conviction": 42, "reasoning": "Steady strength, no binary events on horizon. Not blocking.", "triggers": ["No events", "Normal conditions", "Pass-through"]},
            "weakness": {"direction": "SELL", "conviction": 50, "reasoning": "Weakness but no specific event trigger. Allowing directional trade but watching for event emergence.", "triggers": ["No binary event", "Watching for escalation", "Allowing trade"]},
            "correction": {"direction": "HOLD", "conviction": 72, "reasoning": "Sharp correction may indicate hidden event risk. VIX likely elevated. Cautious — blocking unless conviction is very high.", "triggers": ["VIX spike", "Hidden risk possible", "Precautionary block"]},
        },
        "RBI": {
    ...
    def generate(
        ...
        interaction_map = {
            ...
            "STOCK_OPTIONS": {"amplifies": ["FII stock-level flows", "Sector momentum"], "dampens": ["Macro headwinds opposing stock trend"]},
            "NEWS_EVENT": {"amplifies": ["Event-driven volatility awareness"], "dampens": ["Directional conviction during binary events"]},
        }
