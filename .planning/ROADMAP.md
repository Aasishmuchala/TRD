...
Plans:
- [ ] 09-01-PLAN.md — Extend API client + add /backtest route + Sidebar nav + Backtest.jsx page with form, run action, and progress state
- [ ] 09-02-PLAN.md — BacktestSummary, StatsPanel, and AgentAccuracyTable components wired into Backtest.jsx
...
| 9. Backtest Dashboard | v2.0 | 0/3 | Not started | - |
